...
### Pre-requisites
To use the CUDA version of OpenCV in this project, we have to build our own OpenCV as, by default, the built-in OpenCV shipped with Jetson Nano Jetpack is not having Cuda support ![alt_text](https://qengineering.eu/install-opencv-on-jetson-nano.html). And also need to install pymavlink
